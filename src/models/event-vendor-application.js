...
const schema = mongoose.Schema({
  ...
  status: { type: String, enum: ['SUBMITTED', 'UNDER_REVIEW', 'AWARDED', 'NOT_SELECTED', 'PAYMENT_DUE', 'PAID', 'WITHDRAWN', 'REVOKED'], default: 'SUBMITTED', index: true },
  award_revoked_at: { type: Date, default: null, index: true },
  award_revoked_reason: { type: String, default: null },
  award_revoked_by_user_id: { type: mongoose.Schema.Types.ObjectId, ref: 'users', default: null },
  withdrawn_at: { type: Date, default: null },
  withdrawn_by_user_id: { type: mongoose.Schema.Types.ObjectId, ref: 'users', default: null },
  archived_at: { type: Date, default: null, index: true },
  archived_reason: { type: String, default: null },
  deleted_at: { type: Date, default: null, index: true },
  deleted_reason: { type: String, default: null },
