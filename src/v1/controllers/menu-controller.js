...
// customer ordering so combo and BOGO children can render their required
// flavor, topping, side, and customization controls.
const nestedMenuItemSelect = {
  _id: 1,
  name: 1,
  description: 1,
  imgUrls: 1,
