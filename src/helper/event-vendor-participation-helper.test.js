...
assert.equal(resolveEventVendorParticipationPath({ paymentResponsibility: 'COORDINATOR' }), 'APPLICATION');
assert.equal(resolveEventVendorParticipationPath({ paymentResponsibility: 'VENDOR' }), 'APPLICATION');
assert.equal(resolveEventVendorParticipationPath({ paymentResponsibility: 'BOTH', requestedPath: 'BID' }), 'APPLICATION');
...
assert.equal(resolveEventVendorParticipationPath({ paymentResponsibility: 'BOTH', existingApplication: { participation_path: 'BID', category_fee: 0 } }), 'APPLICATION');
...
assert.equal(resolveEventVendorParticipationPath({ paymentResponsibility: 'UNRECOGNIZED' }), 'APPLICATION');
