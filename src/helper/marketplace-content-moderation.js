const BLOCK_PATTERNS = [
  ...
  { reason: 'hyperlink', pattern: /\b(?:https?:\/\/|www\.|[a-z0-9-]+\.(?:com|net|org|io|co|us|biz|info|me|app|site)\b)/i },
  ...
  { reason: 'direct_contact_request', pattern: /\b(my|our)\s+(number|phone|email|cell|mobile)\b/i },
