...
const getEmployeeScheduleAssignment = (assignments = [], now = new Date(), timeZone = 'America/New_York') => {
...
module.exports = { DAY_KEYS, EARLY_MINUTES, LATE_MINUTES, parseTime, getEmployeeScheduleState, getEmployeeScheduleAssignment };
